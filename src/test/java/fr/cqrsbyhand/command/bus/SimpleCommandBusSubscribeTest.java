...
public class SimpleCommandBusSubscribeTest {
  ...
  public void should_subscribe_command_handler_to_bus() throws Exception {
    ...
    // When
    commandBus.subscribe(AccountCreationCommand.class, new AccountCreationCommandHandler(SimpleEventBus.BUS, MonoRepoEventStore.STORE, denormalizer));
    // Then
    Map<Class<AccountCreationCommand>, AccountCreationCommandHandler> subscribers = new HashMap<>();
    subscribers.put(AccountCreationCommand.class, new AccountCreationCommandHandler(SimpleEventBus.BUS, MonoRepoEventStore.STORE, denormalizer));
